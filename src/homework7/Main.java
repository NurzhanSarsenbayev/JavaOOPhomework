...
public class Main {
    public static void main(String[] args) {
        CalcFactory factory = new CalcAppFactory();

        ICalc num1 = factory.createCalc(2, 3);
        ICalc num2 = factory.createCalc(1, 2);

        ICalc sum = num1.Add(num2);
        ICalc difference = num1.Subtract(num2);
        ICalc product = num1.Multiply(num2);
        ICalc quotient = num1.Divide(num2);
